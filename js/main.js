...
gltfLoader.load(
  "/webdatumwebsite/public/cave/scene.gltf",
  (gltf) => {
...
gltfLoader.load("/webdatumwebsite/public/magic_crystals/scene.gltf", (gltf) => {
...
gltfLoader.load("/webdatumwebsite/public/chest_lootbox/scene.gltf", (gltf) => {
...
gltfLoader.load("webdatumwebsite/public/facebook_logo/scene.gltf", (gltf) => {
...
gltfLoader.load(
  "webdatumwebsite/public/instagram_logo_3d_-_colored/scene.gltf",
  (gltf) => {
...
gltfLoader.load("../webdatumwebsite/public/linkedin_3d/scene.gltf", (gltf) => {
...
function raycasterOnMouseClick(event) {
  ...
  if (intersectsFacebook.length > 0) {
    window.location.href =
      "https://www.facebook.com/profile.php?id=61555817924281";  }
  if (intersectsInstagram.length > 0) {
    window.location.href = "https://www.instagram.com/webdatumconsulting/";
  }
}
